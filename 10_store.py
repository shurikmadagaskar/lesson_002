...
print('Стол -', tables_quantity + tables_quantity_2, 'шт, стоимость', tables_cost + tables_cost_2, 'руб')

#доделать от сюда, всё что выше уже сделано
...
print('Диван -', sofas_quantity + sofas_quantity_2, 'шт, стоимость', sofas_cost + sofas_cost_2, 'руб')
...
chairs_cost_3 = chairs_quantity_3 * chairs_price_2

print('Стул -', chairs_quantity + chairs_quantity_2 + chairs_quantity_3, 'шт, стоимость', chairs_cost + chairs_cost_2 + chairs_cost_3, 'руб')
